...
const rv_opcode_data opcode_data[] = {
    ...
    [rv_op_gctype] = { "gctype", rv_codec_r, rv_fmt_rd_cs1, NULL, 0, 0, 0 },
...
static void decode_inst_opcode(rv_decode *dec, rv_isa isa, int flags)
{
    ...
    case 2:
        ...
        case 1:
            if (isa == rv128) {
                ...
                op = (flags & RISCV_DIS_FLAG_CAPMODE) ? rv_op_c_lcsp : rv_op_c_fldsp;
            }
            break;
    ...
    case 3:
        ...
        case 8:
            ...
            case 3: op = (flags & RISCV_DIS_FLAG_CAPMODE) ? rv_op_csd : rv_op_sd; break;
            case 4:
                if (isa == rv64 && flags & RISCV_DIS_FLAG_CHERI) {
        ...
        case 11:
            ...
            case 20:
                ...
                case 0:
                    if (flags & RISCV_DIS_FLAG_CHERI) {
                        op = (flags & RISCV_DIS_FLAG_CAPMODE) ?
                            rv_op_lr_c_cap_ptr : rv_op_lr_c_int_ptr;
                    }
                    else {
                        op = rv_op_lr_q;
                    }
            ...
            case 28:
                if (flags & RISCV_DIS_FLAG_CHERI) {
                    op = (flags & RISCV_DIS_FLAG_CAPMODE) ?
                        rv_op_sc_c_cap_ptr : rv_op_sc_c_int_ptr;
                }
                else {
                    op = rv_op_sc_q;
                }
