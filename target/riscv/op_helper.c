...
{
    target_ulong val = 0;
    RISCVException ret = riscv_csrrw(env, csr, &val, src, -1, GETPC());
...
{
    target_ulong val = 0;
    RISCVException ret = riscv_csrrw(env, csr, &val, -1, rs1_pass ? src : 0, GETPC());
...
{
    target_ulong val = 0;
    RISCVException ret = riscv_csrrw(env, csr, &val, 0, rs1_pass ? src : 0, GETPC());
